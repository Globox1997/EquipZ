...
public class CoalBase extends ArmorItem {
        ...
        public CoalBase(ArmorMaterial material, EquipmentSlot slot) {
                ...
                builder.put(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(uUID, "MH", 1D,
                                EntityAttributeModifier.Operation.ADDITION));
                builder.put(EntityAttributes.GENERIC_FOLLOW_RANGE, new EntityAttributeModifier(uUID, "FR", 2D,
                                EntityAttributeModifier.Operation.ADDITION));
