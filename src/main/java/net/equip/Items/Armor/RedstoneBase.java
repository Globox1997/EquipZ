...
public class RedstoneBase extends ArmorItem {
        ...
        public RedstoneBase(ArmorMaterial material, EquipmentSlot slot) {
                ...
                builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(uUID, "AS", 0.5D,
                                EntityAttributeModifier.Operation.ADDITION));
                builder.put(EntityAttributes.GENERIC_FOLLOW_RANGE, new EntityAttributeModifier(uUID, "FR", -1.5D,
                                EntityAttributeModifier.Operation.ADDITION));
