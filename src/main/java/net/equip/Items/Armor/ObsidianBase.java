...
public class ObsidianBase extends ArmorItem {
        ...
        public ObsidianBase(ArmorMaterial material, EquipmentSlot slot) {
                ...
                builder.put(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(uUID, "MH", 2D,
                                EntityAttributeModifier.Operation.ADDITION));
                builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(uUID, "MS", -0.005D,
                                EntityAttributeModifier.Operation.ADDITION));
                builder.put(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE, new EntityAttributeModifier(uUID, "KR",
                                0.125D, EntityAttributeModifier.Operation.ADDITION));
                builder.put(EntityAttributes.GENERIC_FOLLOW_RANGE, new EntityAttributeModifier(uUID, "FR", 4D,
                                EntityAttributeModifier.Operation.ADDITION));
