...
public class EmeraldBase extends ArmorItem {
    ...
    public EmeraldBase(ArmorMaterial material, EquipmentSlot slot) {
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_SPEED,
                new EntityAttributeModifier(uUID, "AS", 0.5D, EntityAttributeModifier.Operation.ADDITION));
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE,
                new EntityAttributeModifier(uUID, "AD", 0.7D, EntityAttributeModifier.Operation.ADDITION));
